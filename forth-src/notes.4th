...
\
\ Copyright (c) 2001--2021 Krishna Myneni
...
\
\ 3. Change the default notes file name DEF-NOTES-FILE for your use.
\
\ 4. The notes database index has not been fully implemented.
...
s" /home/"     s" /notes.db"
[ELSE]
s" C:\Users\"  s" \Documents\notes.db"
[THEN]
2swap get-username strcat 2swap strcat  $constant  DEF-NOTES-FILE
...
: open-notes ( n -- | open the notes file with access method given by n )
	...
	BIN my-notes-file count rot open-file
...
: open-notes-append ( -- )
	my-notes-file count R/W BIN open-file
	if drop E-OPEN-MSG type  
	  my-notes-file count type cr abort
	then
	my-notes-fd !
